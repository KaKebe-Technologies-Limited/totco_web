<?php include 'modalFunctions.php'; ?>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="form-group col-md-4">
                                ...
                                <input name="pdt_code" type="text" class="form-control" placeholder="Product Code">
                            </div>
                            <div class="form-group col-md-8">
                                <label for="Name">Product Name</label>
                                <input name="pdt_name" type="text" class="form-control" placeholder="Product Name">
                            </div>
                            <div class="form-group col-md-4">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <!-- <input name="net_price" class="form-control" type="text" data-type="currency" placeholder="P 0.00"> -->
                                <input name="net_price" class="form-control" type="number" placeholder="Shs 0.00">
                            </div>
                            <div class="form-group col-md-4">
                                <label for="Sales Price">Sales Price</label>
                                <input name="sales_price" class="form-control" type="number" placeholder="Shs 0.00">
                            </div>
                            <div class="form-group col-md-4">
                                <label for="Expiry Date">Expiry Date</label>
                                <input name="expiry_date" type="date" class="form-control" id="Expiry Date" placeholder="Expiry Date">
                            </div>
                            <div class="form-group col-md-4">
                                <label for="UnitPrice">Unit Price</label>
                                <input name="unit_price" class="form-control" type="number" placeholder="Shs 0.00">
                            </div>
                            <div class="form-group col-md-4">
                                <label for="UnitMeasurement">Unit Measurement</label>
                                <input name="unit_measurement" type="text" class="form-control" id="UnitMeasurement" placeholder="Unit Measurement">
                            </div>
                            <div class="form-group col-md-4">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input name="discount_price" class="form-control" type="number" placeholder="P 0.00">
                            </div>
                            <div class="form-group col-md-4">
                        ...
                        <button name="addProductSubmit" type="submit" class="btn btn-primary btn-rounded">Save</button>
...
<div class="modal fade" id="add-Users">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <!-- <form method="POST" onsubmit="displayAlert();"> -->
                <form method="POST">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <input name="passwordConfirm" type="text" class="form-control" id="Password" placeholder="Password">
                            </div>

                        </div>
                        <button name="add_user_submit" type="submit" class="btn btn-primary btn-rounded">Add User</button>
                        <button type="button" class="btn btn-default btn-rounded" data-dismiss="modal">Cancel</button>
                    </div>
                    <!-- /.card-body -->
            ...
            <div class="modal-body">
                <form method="POST">
                    <div class="card-body">
                        <div class="row">
                            <div class="form-group col-md-12">
                                <label for="Username">Update user with user name</label>
                                <span id="updateAddon" style="color: green;"></span>
                                <span>?</span>
                                <input name="user_name" type="text" class="form-control" id="UserNameUpdate" placeholder="Username" style="display: none;">
                            </div>
                            <div class="form-group col-md-12">
                                <label for="Full Name">Full Name</label>
                                <input name="full_name" type="text" class="form-control" id="Full Name" placeholder="First Name      -       Middle Name         -       Last Name">
                            </div>
                            <div class="form-group col-md-12">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <input name="passwordConfirm" type="password" class="form-control" id="PasswordConfirm" placeholder="Password">
                            </div>
                            <div class="form-group col-md-12">
                                <label for="User Type">User Type</label>
                                <select name="admin_roles" class="form-control">
                                    <option value="0">ORDINARY</option>
                                    <option value="1">ADMIN</option>
                                </select>
                            </div>
                            <div class="form-group col-md-12">
                                <label for="User Type">User Roles</label>
                                <select name="advanced_roles" class="form-control">
                                    <option value="0">ORDINARY</option>
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <input name="contact" type="text" class="form-control" id="Contact Number" placeholder="Contact Number">
                            </div>
                            <div class="form-group col-md-12">
                                <label for="Address">Email Address</label>
                                <input name="email" type="email" class="form-control" id="Address" placeholder="Email Address">
                            </div>
                        </div>
                        <button name="updateUserSubmit" type="submit" class="btn btn-primary btn-rounded">Save</button>
                        <button type="button" class="btn btn-default btn-rounded" data-dismiss="modal">Cancel</button>
                    </div>
                    <!-- /.card-body -->
                ...
                <form method="POST">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="form-group col-md-12">
                                <label for="Username">Delete user with user name</label>
                                <span id="deleteAddon" style="color: red;"></span>
                                <span>?</span>
                                <input name="user_name" type="text" class="form-control" id="UserNameDelete" placeholder="Username" style="display: none;">
                            </div>

                        </div>
                        <button name="deleteUserSubmit" type="submit" class="btn btn-danger btn-rounded">Confirm</button>
                        <button type="button" class="btn btn-default btn-rounded" data-dismiss="modal">Cancel</button>
                    </div>
                    <!-- /.card-body -->
